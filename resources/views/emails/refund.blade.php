...
<div class="max-w-lg mx-auto mt-10 bg-white p-6 rounded-lg shadow-lg">
    ...
    <p class="mb-4">Votre annulation a bel et bien été enregistré et nous vous informons le remboursement de {{$annonce->price}} €</p>
    <div class="mb-4">
        <h2 class="text-xl font-semibold mb-2">Information relative à l'annonce':</h2>
        <p class="ml-4">
            <span class="font-medium">Titre:</span> {{$annonce->title}}
        </p>
