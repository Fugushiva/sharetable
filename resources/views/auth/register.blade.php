    ...
    <x-guest-layout>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                ...
                <input id="lastname" class="block mt-1 w-full" type="text" name="lastname" required autofocus
                       autocomplete="name">
            ...
            <div class="mt-4">
                ...
                <input id="password_confirmation" class="form-input block mt-1 w-full" type="password"
            ...
            <div class="mt-4">
                ...
                <select id="language" name="language_name">
