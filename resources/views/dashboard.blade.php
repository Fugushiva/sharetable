<x-app-layout>
    <div class="container mx-auto">
        ...
        <section class="relative bg-cover bg-center" style="background-image: url('{{ asset("img/site/charac/bring.jpg") }}'); height: 400px;">
        ...
        <section class="mt-12 text-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-lg shadow-lg p-6">
                    <img src="#" alt="Rechercher un hôte" class="w-full h-48 object-cover mb-4">
                ...
                <div class="bg-white rounded-lg shadow-lg p-6">
                    <img src="#" alt="Découverte de cuisine" class="w-full h-48 object-cover mb-4">
                ...
                <div class="bg-white rounded-lg shadow-lg p-6">
                    <img src="#" alt="Partage d'expérience" class="w-full h-48 object-cover mb-4">
