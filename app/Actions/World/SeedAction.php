...
class SeedAction extends Seeder
{
    ...
    private function initModule(string $module)
    {
        if (array_key_exists($module, $this->modules)) {
            ...
            $moduleSourcePath = resource_path('json/' . $module . '.json');
    ...
    private function initCountries(): void
    {
        ...
        // Tronquer la table countries
        app(Models\Country::class)->truncate();

        // Importer les données du fichier JSON
        $this->countries['data'] = json_decode(File::get(resource_path('json/countries.json')), true);
